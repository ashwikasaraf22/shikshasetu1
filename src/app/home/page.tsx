  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50 via-pink-50 to-yellow-50 text-gray-800">
      ...
      <header className="max-w-6xl mx-auto px-4 sm:px-6 py-8 flex flex-col items-center justify-center text-center relative">
        ...
        {/* On mobile: stack below heading to avoid overlap; on >=sm keep absolute in header corner */}
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <section className="relative rounded-3xl bg-gradient-to-r from-purple-200 via-pink-100 to-blue-50 p-6 sm:p-10 mb-10 overflow-hidden shadow-xl">
          {/* Background icons (hide on small screens to prevent text overlap) */}
          <BookText className="hidden sm:block absolute -top-12 -left-12 h-44 w-44 text-purple-300 opacity-20 rotate-12" />
          <MessageCircle className="hidden sm:block absolute -bottom-12 -right-12 h-44 w-44 text-pink-300 opacity-20 rotate-12" />
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mb-10">
          {/* Smart AI Tutor Card */}
          <Card className="relative rounded-3xl bg-gradient-to-br from-purple-200 via-purple-100 to-purple-50 shadow-lg hover:shadow-2xl transition-transform hover:-translate-y-1 break-words">
            <BookText className="hidden sm:block absolute -top-5 -right-5 h-32 w-32 text-purple-300 opacity-20 rotate-12 pointer-events-none" />
            <CardHeader className="relative z-10">
              <CardTitle className="flex items-center gap-3 text-purple-700">
                <BookText className="h-8 w-8 shrink-0" />
                <T>Smart AI Tutor</T>
              </CardTitle>
              <CardDescription>
          ...
          <Card className="relative rounded-3xl bg-gradient-to-br from-pink-200 via-pink-100 to-pink-50 shadow-lg hover:shadow-2xl transition-transform hover:-translate-y-1 break-words">
            <Eye className="hidden sm:block absolute -top-5 -right-5 h-32 w-32 text-pink-300 opacity-20 rotate-12 pointer-events-none" />
            <CardHeader className="relative z-10">
