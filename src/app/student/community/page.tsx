...
function CommunityHome() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-[#ECE7FF] via-[#F6F3FF] to-[#E3F1FF] text-gray-800 overflow-hidden">
      ...
      >
        <path
          d="M40 80 q60 30 140 -20 q40 -20 90 0"
          stroke="#B6E3D2"
          strokeWidth="5"
          fill="none"
          strokeLinecap="round"
      ...
      <main className="relative z-10 max-w-6xl mx-auto p-6">
        <div className="relative mb-12 text-center">
          ...
          <p className="text-[#5A4DA8]/80 text-base mt-1 max-w-2xl mx-auto">
            <T>
              Pick what you want to do today—join a workshop, take a test, watch
              videos, or share with the community.
            </T>
          </p>
        </div>
          ...
          {tabs.map((tab, idx) => {
            ...
            return (
              ...
              >
                ...
                >
                  <path
                    d="M10 50 Q 25 30, 40 50 T 70 50"
                    stroke="#C9B8FF"
                    strokeWidth="3"
                    fill="none"
                  />
